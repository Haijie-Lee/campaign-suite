#!/usr/bin/env python
"""AC-07 投递 9 个文件（含 1 个 1 GB + 8 个小文件），UI 无卡顿，全部校验通过 — 验收骨架（三态结构）。
source: SRS §8.3 条目 7（基础 12 条）；refs: FR-1。
阈值（逐字自 §8.3 正文，进代码常量）：9 文件 / 1 GB"""
import sys
