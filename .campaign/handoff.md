...
- 当前单元：无（W1–W4 四波全量建成；**aerofold-m0 程序 6/7 complete + 1 blocked 挂起收官@2026-09-21**）
...
- 关键路径：设计文档与调研 = C:\Users\Administrator\WorkBuddy\2026-09-20-21-39-26\（campaign插件设计文档.md v1.2、W1–W4 plan 等 10 份）；fixture = C:\Users\Administrator\WorkBuddy\2026-09-20-19-14-14\AeroFold-需求规格与技术架构方案.md（v0.7：C1–C11、Q18/Q19 冻结）；M0 证据 = .campaign/evidence/m0/（u01–u06）；PoC 工程 = /tmp/u04-poc/（rust-poc/iroh-poc/py 脚本+bench 数据，**iroh-poc 可改造为双端实测版**）
